# Aceptacion de la Fase 1, RONDA 2 (2026-09-17): veredictos de Mariano sobre `ask` v2 -- FASE 1 ACEPTADA

Conservada tal cual. Tres flecos (c: p+1/p-1 y version arXiv/revista; b: etiqueta impresa (C); tabla sin duplicados) van a `ask` v2.1.
...
La condición anterior es equivalente a que $d_M(t)$ satisfaga la condición $(\mathrm{OA3:1})$. [jimenez-garrido-sanz-2016:p11, teorema, etiqueta LaTeX: teorcondicion3caracterizacion]
...
|---|---|---|---|
| 0 | que condiciones sobre la sucesion M usa el teorema de extens... | [thilliez-2003:p5]; [jimenez-garrido-cantero-sanz-schindl-2023:p16]; [thilliez-2003:p10] | correcta — Definición 1.3.1 y teorema de p10 verificados; hipótesis exactas. |
| a | Segun Thilliez 2010, que hipotesis sobre M exige el resultad... | [thilliez-2010:p7] | correcta — Teorema 3, p7, verificado; no falta ninguna hipótesis. |
| b | Que relacion demuestran Jimenez-Garrido y Sanz (2016) entre ... | [jimenez-garrido-sanz-2016:p11]; [jimenez-garrido-sanz-2016:p21]; [jimenez-garrido-sanz-2016:p21] | correcta — Teorema 4.19 pide exactamente esa condición. Lo que el texto llama "(OA3:1)" es la condición (C) del paper: la etiqueta impresa no se resolvió bien en p11. |
| c | Como se define la M-sumabilidad en una direccion en Lastra-M... | [lastra-malek-sanz-2015:p19]; [lastra-malek-sanz-2015:p8]; [lastra-malek-sanz-2015:p20]; [lastra-malek-sanz-2015:p20]; [lastra-malek-sanz-2015:p7] | incorrecta (un detalle) — definición p7 exacta y lista de equivalencias en Prop. 4.13 confirmada, pero el límite es (p−1)/M(m_p), no (p+1). Comprobar si el .tex de arXiv dice p+1 (discrepancia de versión) o si es error de lectura. |
| d | En Jimenez-Garrido-Sanz-Schindl 2019, que indice separa las ... | [jimenez-garrido-sanz-schindl-2019-injectivity:p11]; [jimenez-garrido-sanz-schindl-2019-injectivity:p15]; [jimenez-garrido-sanz-schindl-2019-injectivity:p28] | correcta — Teorema 3.4 es un "si y solo si"; la caracterización completa de la sobreyectividad (y que Borel nunca es biyectiva) está en Jiménez-Garrido–Miguel-Cantero–Sanz–Schindl 2026, no en 2019, así que la respuesta es fiel al paper preguntado. |
| e | Que prueba el corpus sobre la sumabilidad de soluciones de e... | [jimenez-garrido-tesis-2018:p10]; [lastra-malek-sanz-2015:p1]; [balser-2000:p221]; [balser-2000:p53]; [thilliez-2010:p4]; [balser-2000:p53]; [thilliez-2010:p4] | correcta — control negativo superado: segunda búsqueda declarada, nada sin cita. |
